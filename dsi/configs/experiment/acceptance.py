...
class ConfigAcceptanteRate(ConfigLatency):
    ...
    draft_compile_model: bool = Field(False, title="Whether to torch.compile() the draft model")
    draft_revision: None | str = Field(None, title="The revision of the draft model to use")
